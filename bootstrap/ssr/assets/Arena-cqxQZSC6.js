...
function Arena({ match }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-100 dark:bg-black text-slate-900 dark:text-white p-6 flex flex-col items-center font-sans selection:bg-blue-500 selection:text-white transition-colors duration-300", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full max-w-3xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-slate-200 dark:border-slate-700/50 rounded-3xl p-8 min-h-[400px] flex flex-col items-center justify-center relative shadow-2xl transition-colors duration-300", children: [
      gameState === "waiting" && !opponent && /* @__PURE__ */ jsxs("div", { className: "text-center space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold tracking-tight text-slate-800 dark:text-white", children: t("Searching for Opponent") }),
          /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 mt-2", children: t("Connecting to global matchmaking server...") })
        ] })
      ] }),
      gameState === "starting" && /* @__PURE__ */ jsxs("div", { className: "text-center space-y-4", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-600 animate-bounce", children: t("MATCH FOUND!") }),
        /* @__PURE__ */ jsx("p", { className: "text-xl text-slate-600 dark:text-slate-300", children: t("Preparing battle...") })
      ] }),
      gameState === "question" && currentQuestion && /* @__PURE__ */ jsxs("div", { className: "w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center space-y-4", children: [
          /* @__PURE__ */ jsx("span", { className: "px-3 py-1 bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold uppercase tracking-widest rounded-full border border-blue-500/20", children: currentQuestion.category || t("General Knowledge") }),
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold leading-tight md:text-4xl text-slate-900 dark:text-white", children: currentQuestion.question_text })
        ] }),
      ...
      gameState === "result" && /* @__PURE__ */ jsxs("div", { className: "text-center space-y-8 animate-in zoom-in duration-300", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-5xl font-black text-slate-900 dark:text-white", children: t("GAME OVER") }),
        /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-12", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 text-sm uppercase font-bold", children: t("You") }),
            /* @__PURE__ */ jsx("p", { className: `text-6xl font-black ${score > opponentScore ? "text-green-600 dark:text-green-400" : "text-slate-700 dark:text-slate-200"}`, children: score })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 text-sm uppercase font-bold", children: t("Opponent") }),
            /* @__PURE__ */ jsx("p", { className: `text-6xl font-black ${opponentScore > score ? "text-green-600 dark:text-green-400" : "text-slate-700 dark:text-slate-200"}`, children: opponentScore })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold", children: score > opponentScore ? /* @__PURE__ */ jsx("span", { className: "text-green-600 dark:text-green-400", children: t("VICTORY! +50 PTS") }) : score < opponentScore ? /* @__PURE__ */ jsx("span", { className: "text-red-500 dark:text-red-400", children: t("DEFEAT -10 PTS") }) : /* @__PURE__ */ jsx("span", { className: "text-yellow-500 dark:text-yellow-400", children: t("DRAW") }) }),
        /* @__PURE__ */ jsx(
          "button",
          {
