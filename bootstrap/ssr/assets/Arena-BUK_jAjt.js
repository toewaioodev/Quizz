...
function Arena({ match }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative flex min-h-screen flex-col items-center overflow-hidden bg-slate-50 font-sans text-slate-900 transition-colors duration-300 selection:bg-blue-500 selection:text-white dark:bg-slate-950 dark:text-white", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "z-10 flex w-full max-w-4xl flex-1 flex-col justify-center p-2 md:p-4", children: /* @__PURE__ */ jsxs("div", { className: "relative flex min-h-[400px] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white/80 shadow-2xl backdrop-blur-xl transition-all duration-500 md:min-h-[500px] dark:border-white/10 dark:bg-slate-900/60", children: [
      ...
      state.status === "GAME_OVER" && /* @__PURE__ */ jsx(GameOverDisplay, { score, opponentScore, isWinner, isDraw })
    ] }) })
  ] });
}
const QuestionDisplay = memo(({ currentQuestion, status, lastRoundResult, hasAnswered, opponentAnswered, submitAnswer, userAnswer }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto flex w-full max-w-4xl flex-1 flex-col p-4 md:p-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "relative mb-8 overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 p-1 shadow-lg backdrop-blur-md dark:from-indigo-500/5 dark:to-purple-500/5", children: [
      /* @__PURE__ */ jsx("div", { className: "animate-gradient-x absolute top-0 left-0 h-1 w-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500" }),
      /* @__PURE__ */ jsxs("div", { className: "relative rounded-xl bg-white/50 p-6 text-center md:p-10 dark:bg-slate-900/50", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6", children: displayOptions.map((opt, idx) => {
      ...
      let icon = /* @__PURE__ */ jsx("span", { className: "flex h-8 w-8 items-center justify-center rounded-lg border border-current text-sm font-bold opacity-70 transition-all group-hover:border-transparent group-hover:bg-current group-hover:text-white", children: String.fromCharCode(65 + idx) });
      if (hasAnswered) {
      ...
      return /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            !hasAnswered && !showResult && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 translate-x-[-100%] -skew-x-12 bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-0 transition-opacity duration-300 group-hover:translate-x-[100%] group-hover:opacity-100" })
          ]
        },
        idx
      );
    }) }),
    opponentAnswered && !lastRoundResult && /* @__PURE__ */ jsx("div", { className: "mt-8 flex justify-center", children: /* @__PURE__ */ jsxs("div", { className: "flex animate-pulse items-center gap-2 rounded-full bg-red-100 px-4 py-2 text-sm font-bold text-red-600 dark:bg-red-900/30 dark:text-red-400", children: [
