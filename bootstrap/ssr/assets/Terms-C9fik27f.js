  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white font-sans transition-colors duration-300", children: [
      ...
      /* @__PURE__ */ jsxs("main", { className: "max-w-4xl mx-auto px-6 py-16", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold mb-8", children: t("terms.title") }),
        /* @__PURE__ */ jsxs("div", { className: "prose dark:prose-invert max-w-none space-y-6", children: [
          /* @__PURE__ */ jsxs("section", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-4", children: t("terms.section1_title") }),
            /* @__PURE__ */ jsx("p", { className: "text-slate-600 dark:text-slate-400", children: t("terms.section1_content") })
          ] }),
          /* @__PURE__ */ jsxs("section", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-4", children: t("terms.section2_title") }),
            /* @__PURE__ */ jsx("p", { className: "text-slate-600 dark:text-slate-400", children: t("terms.section2_content") })
          ] }),
          /* @__PURE__ */ jsxs("section", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-4", children: t("terms.section3_title") }),
