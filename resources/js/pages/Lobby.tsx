            ...
            <div className="custom-scrollbar max-h-[500px] space-y-2 overflow-y-auto pr-2">
                {activeUsers.map((p: any) => (
                    ...
                    >
                        ...
                        {p.status === 'playing' && (
                            <div className="flex items-center gap-1 rounded-full bg-orange-100 px-2 py-0.5 text-xs font-medium text-orange-600 dark:bg-orange-900/30 dark:text-orange-400">
                                {t('Playing')}
                            </div>
                        )}
