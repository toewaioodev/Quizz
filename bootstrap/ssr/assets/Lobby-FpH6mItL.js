...
function Lobby() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative flex min-h-screen flex-col items-center overflow-hidden bg-slate-50 dark:bg-slate-950 p-0 text-slate-900 dark:text-white transition-colors duration-300", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "z-10 mt-8 grid w-full max-w-4xl grid-cols-1 items-start gap-8 p-6 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-8 text-center md:text-left", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx("h1", { className: "bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-4xl font-bold tracking-tighter text-transparent", children: t("Quiz Battle") }),
          /* @__PURE__ */ jsx("p", { className: "text-slate-600 dark:text-slate-400", children: t("Compete in real-time 1v1 matches.") })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-slate-200 dark:border-white/10 bg-white/50 dark:bg-slate-900/50 p-6 shadow-xl backdrop-blur-xl", children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-6 flex items-center justify-between border-b border-slate-200 dark:border-white/5 pb-6", children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `group relative w-full overflow-hidden rounded-xl p-[1px] transition-all ${(user.points || 0) < 10 ? "cursor-not-allowed bg-slate-300 dark:bg-slate-700 opacity-50" : "bg-gradient-to-r from-blue-600 to-violet-600 hover:scale-[1.02] active:scale-[0.98]"}`,
              children: /* @__PURE__ */ jsx(
                "div",
                {
                  className: `relative flex h-14 items-center justify-center gap-3 rounded-[11px] transition-colors ${(user.points || 0) < 10 ? "bg-slate-100 dark:bg-slate-900" : "bg-slate-50 dark:bg-slate-950/50 group-hover:bg-transparent"}`,
                  children: searching ? /* @__PURE__ */ jsxs(Fragment, { children: [
                    /* @__PURE__ */ jsx("div", { className: "h-5 w-5 animate-spin rounded-full border-2 border-slate-400 dark:border-white/30 border-t-slate-800 dark:border-t-white" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("button", { className: "group rounded-xl border border-slate-200 dark:border-white/5 bg-white/50 dark:bg-slate-900/50 p-4 text-left transition-colors hover:border-purple-400/50 dark:hover:border-white/20", children: [
            /* @__PURE__ */ jsx("div", { className: "mb-2 origin-left text-purple-600 dark:text-purple-400 transition-transform group-hover:scale-110", children: /* @__PURE__ */ jsx("svg", { className: "h-6 w-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx(
              "path",
              {
                strokeLinecap: "round",
                strokeLinejoin: "round",
          ...
          /* @__PURE__ */ jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "mb-2 origin-left text-blue-600 dark:text-blue-400 transition-transform group-hover:scale-110", children: /* @__PURE__ */ jsx("svg", { className: "h-6 w-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx(
                  "path",
                  {
                    strokeLinecap: "round",
                    strokeLinejoin: "round",
      ...
      /* @__PURE__ */ jsxs("div", { className: "h-full min-h-[400px] rounded-2xl border border-slate-200 dark:border-white/5 bg-white/30 dark:bg-slate-900/30 p-6 backdrop-blur-md", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "custom-scrollbar max-h-[500px] space-y-2 overflow-y-auto pr-2", children: [
          activeUsers.map((p) => /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-tr from-blue-500 to-teal-500 text-sm font-bold shadow-sm text-white", children: p.data.name.charAt(0) }),
