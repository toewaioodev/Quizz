...
const ActivePlayersList = memo(({ activeUsers, user, handleInvite }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex h-full min-h-[500px] flex-col overflow-hidden rounded-3xl border border-white/10 bg-slate-900/50 backdrop-blur-md", children: [
    /* @__PURE__ */ jsxs("div", { className: "border-b border-white/5 p-6", children: [
      /* @__PURE__ */ jsxs("h2", { className: "flex items-center gap-3 text-lg font-bold text-white", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-4 relative", children: [
        ...
        /* @__PURE__ */ jsx("svg", { className: "absolute left-3 top-2.5 h-4 w-4 text-slate-500", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "custom-scrollbar flex-1 overflow-y-auto p-4 space-y-2", children: isSearchingAPI ? /* @__PURE__ */ jsx("div", { className: "flex justify-center p-4", children: /* @__PURE__ */ jsx("div", { className: "h-6 w-6 animate-spin rounded-full border-2 border-white/30 border-t-blue-500" }) }) : displayUsers.length === 0 ? /* @__PURE__ */ jsx("div", { className: "flex h-full flex-col items-center justify-center text-slate-500", children: searchTerm ? /* @__PURE__ */ jsx("p", { children: t("No players found.") }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: `absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full border-2 border-slate-900 ${p.status === "playing" ? "bg-orange-500" : p.status === "searching" ? "bg-blue-500" : p.status === "online" ? "bg-green-500" : "bg-slate-500"}` })
          ] }),
