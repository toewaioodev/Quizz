                ...
                return (
                    ...
                    >
                        ...
                        <div className={`relative mb-1.5 sm:mb-2 ${isFirst ? 'animate-float' : ''}`}>
                            ...
                            <div className={`rounded-full p-0.5 ${isFirst ? 'gradient-success glow-success' : 'bg-border'}`}>
                        ...
                        <span className="text-card-foreground mb-0.5 max-w-[60px] truncate text-xs font-semibold sm:mb-1 sm:max-w-[80px] sm:text-sm">
                            {player.name}
                        </span>
                        ...
                        {/* Podium base */}
                        <div
                            className={`w-16 sm:w-20 ${heights[index]} flex items-start justify-center rounded-t-xl pt-2 sm:rounded-t-2xl sm:pt-3 ${
                                isFirst ? 'gradient-success glow-success' : 'bg-amber-300'
                            }`}
                        >
                            <span
                                className={`font-display text-xl font-bold sm:text-2xl ${
                                    isFirst ? 'text-success-foreground' : 'text-card-foreground'
                                }`}
                            >
                                #{player.rank}
                            </span>
