  ...
  return /* @__PURE__ */ jsx("div", { className: "flex items-end justify-center gap-14 px-4 pt-6 pb-2 sm:gap-5 sm:px-6 sm:pt-8 sm:pb-4", children: ordered.map((player, index) => {
    ...
    return /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs(Link, { href: `/u/${player.username || player.id}`, className: "flex flex-col items-center group", children: [
            /* @__PURE__ */ jsxs("div", { className: `relative mb-1.5 sm:mb-2 ${isFirst ? "animate-float" : ""}`, children: [
              ...
              /* @__PURE__ */ jsx("div", { className: `rounded-full p-0.5 transition-all group-hover:scale-105 ${isFirst ? "gradient-success glow-success" : "bg-border"}`, children: /* @__PURE__ */ jsx("div", { className: `${avatarSizes[index]} bg-card overflow-hidden rounded-full`, children: /* @__PURE__ */ jsx("img", { src: player.avatar, alt: player.name, className: "h-full w-full object-cover" }) }) })
            ] }),
            /* @__PURE__ */ jsx("span", { className: "text-card-foreground mb-0.5 max-w-[60px] truncate text-xs font-semibold transition-colors group-hover:text-blue-400 sm:mb-1 sm:max-w-[80px] sm:text-sm", children: player.name }),
...
function Leaderboard({ users }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen font-sans text-slate-900 transition-colors duration-300 dark:text-gray-100 pb-24 md:pb-0 relative isolate", children: [
          ...
          return /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs(Link, { href: `/u/${user.username || user.id}`, className: "col-span-6 flex items-center gap-3 min-w-0 group-hover:opacity-80 transition-opacity", children: [
                  /* @__PURE__ */ jsx(
                    "img",
                    {
