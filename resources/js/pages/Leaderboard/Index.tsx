        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-gray-100 transition-colors duration-300">
            ...
            <div className="z-10 w-full max-w-2xl mx-auto p-6 space-y-8 mt-10">
                ...
                <div className="bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl shadow-xl overflow-hidden">
                    <div className="text-left text-xs font-bold text-slate-500 uppercase tracking-wider p-4 border-b border-white/5 grid grid-cols-12 gap-4">
                    ...
                    <div className="divide-y divide-white/5">
                        {users.map((user, index) => {
                            ...
                            return (
                                <div key={user.id} className={`grid grid-cols-12 gap-4 p-4 items-center transition-colors ${isMe ? 'bg-blue-600/10 hover:bg-blue-600/20' : 'hover:bg-white/5'}`}>
                                    <div className="col-span-1 text-center font-bold text-slate-400">
                                        {index + 1}
                                    </div>
                                    <div className="col-span-5 flex items-center gap-3">
                                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${index === 0 ? 'bg-yellow-500 text-black' :
