...
function Register() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen items-center justify-center bg-slate-50 p-4 font-sans text-slate-900 transition-colors duration-300 dark:bg-slate-950 dark:text-white", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-md overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 shadow-2xl sm:p-10 dark:border-slate-800 dark:bg-slate-900", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute -right-16 -top-16 h-48 w-48 rounded-full bg-gradient-to-br from-pink-500/20 to-orange-500/20 blur-3xl" }),
      /* @__PURE__ */ jsx("div", { className: "absolute -bottom-16 -left-16 h-48 w-48 rounded-full bg-gradient-to-tr from-purple-500/20 to-pink-500/20 blur-3xl" }),
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx(
            "input",
            {
              id: "name",
              type: "text",
              className: `w-full rounded-xl border-2 py-3.5 pl-4 pr-4 font-medium text-slate-900 placeholder-slate-400 transition-all outline-none focus:ring-4 dark:bg-slate-800 dark:text-white dark:placeholder-slate-500 ${errors.name ? "border-red-300 focus:border-red-500 focus:ring-red-500/20 dark:border-red-800" : "border-slate-200 focus:border-pink-500 focus:ring-pink-500/20 dark:border-slate-700 dark:focus:border-pink-500"}`,
              value: data.name,
          ...
          errors.name && /* @__PURE__ */ jsx("div", { className: "mt-1.5 pl-1 text-xs font-bold text-red-500", children: errors.name })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
