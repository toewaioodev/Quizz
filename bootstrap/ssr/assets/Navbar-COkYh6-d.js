...
import { GlobeAltIcon, ChevronDownIcon as ChevronDownIcon$1, UserIcon, ArrowRightOnRectangleIcon } from "@heroicons/react/24/outline";
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsx("header", { className: "bg-white/80 dark:bg-slate-900/80 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-50 w-full backdrop-blur-md transition-colors duration-300", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex justify-between items-center", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-4", children: [
      ...
      /* @__PURE__ */ jsxs(Dropdown, { children: [
        /* @__PURE__ */ jsx(Dropdown.Trigger, { children: /* @__PURE__ */ jsxs("button", { className: "flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors focus:outline-none", children: [
          /* @__PURE__ */ jsx("div", { className: "cursor-pointer w-6 h-6 rounded-full bg-gradient-to-tr from-yellow-400 to-orange-500 flex items-center justify-center text-[10px] font-bold text-white shadow-sm", children: auth.user.name.charAt(0) }),
