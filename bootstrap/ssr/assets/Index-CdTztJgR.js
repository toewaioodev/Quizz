  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-gray-100 transition-colors duration-300", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "z-10 w-full max-w-2xl mx-auto p-6 space-y-8 mt-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-4", children: /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold tracking-tighter bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent", children: t("Leaderboard") }) }),
        /* @__PURE__ */ jsx("div", { className: "w-20" }),
        " "
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl shadow-xl overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-left text-xs font-bold text-slate-500 uppercase tracking-wider p-4 border-b border-white/5 grid grid-cols-12 gap-4", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "divide-y divide-white/5", children: users.map((user, index) => {
          const isMe = user.id === auth.user.id;
          const winRate = user.wins + user.losses > 0 ? Math.round(user.wins / (user.wins + user.losses) * 100) : 0;
          return /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-12 gap-4 p-4 items-center transition-colors ${isMe ? "bg-blue-600/10 hover:bg-blue-600/20" : "hover:bg-white/5"}`, children: [
            /* @__PURE__ */ jsx("div", { className: "col-span-1 text-center font-bold text-slate-400", children: index + 1 }),
            /* @__PURE__ */ jsxs("div", { className: "col-span-5 flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: `w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${index === 0 ? "bg-yellow-500 text-black" : index === 1 ? "bg-slate-400 text-black" : index === 2 ? "bg-orange-700 text-white" : "bg-slate-800 text-slate-300"}`, children: user.name.charAt(0).toUpperCase() }),
              /* @__PURE__ */ jsxs("span", { className: `font-medium ${isMe ? "text-blue-400" : "text-slate-200"}`, children: [
                user.name,
                " ",
                isMe && "(You)"
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "col-span-2 text-center font-bold text-purple-400", children: user.points }),
            /* @__PURE__ */ jsxs("div", { className: "col-span-2 text-center text-sm text-slate-400", children: [
              /* @__PURE__ */ jsx("span", { className: "text-green-400", children: user.wins }),
              " - ",
              /* @__PURE__ */ jsx("span", { className: "text-red-400", children: user.losses })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "col-span-2 text-center text-sm font-medium text-slate-400", children: [
              winRate,
              "%"
            ] })
          ] }, user.id);
