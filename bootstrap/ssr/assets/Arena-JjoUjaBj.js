  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative flex min-h-screen flex-col items-center overflow-hidden bg-slate-50 font-sans text-slate-900 transition-colors duration-300 selection:bg-blue-500 selection:text-white dark:bg-slate-950 dark:text-white", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "sticky top-0 z-10 mx-auto flex w-full max-w-6xl flex-row items-center justify-between border-b border-slate-200 bg-white/50 p-4 backdrop-blur-sm md:static md:border-none md:bg-transparent dark:border-white/5 dark:bg-black/20", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
        ...
        ) : /* @__PURE__ */ jsx("div", { className: "text-2xl font-black text-slate-300 italic md:text-4xl dark:text-slate-700", children: gameState === "starting" ? "VS" : gameState === "waiting" ? t("WAITING") : "" }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "flex h-20 w-20 items-center justify-center rounded-full border-4 border-white bg-blue-600 text-3xl font-bold shadow-xl md:h-24 md:w-24 dark:border-slate-800 overflow-hidden", children: /* @__PURE__ */ jsx("img", { src: user.profile_photo_url, alt: user.name, className: "w-full h-full object-cover" }) }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "flex h-20 w-20 items-center justify-center rounded-full border-4 border-white bg-red-600 text-3xl font-bold shadow-xl md:h-24 md:w-24 dark:border-slate-800 overflow-hidden", children: opponent ? /* @__PURE__ */ jsx("img", { src: opponent.profile_photo_url || `https://ui-avatars.com/api/?name=${opponent.name}&color=7F9CF5&background=EBF4FF`, alt: opponent.name, className: "w-full h-full object-cover" }) : "?" })
                ] }),
