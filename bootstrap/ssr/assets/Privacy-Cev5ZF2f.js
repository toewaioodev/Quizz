  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50 font-sans text-slate-900 transition-colors duration-300 dark:bg-slate-900 dark:text-white", children: [
      ...
      /* @__PURE__ */ jsxs("main", { className: "mx-auto max-w-4xl px-6 py-16", children: [
        /* @__PURE__ */ jsx("h1", { className: "mb-8 text-4xl font-bold", children: t("privacy.title") }),
        /* @__PURE__ */ jsxs("div", { className: "prose dark:prose-invert max-w-none space-y-6", children: [
          /* @__PURE__ */ jsxs("section", { children: [
            /* @__PURE__ */ jsx("h2", { className: "mb-4 text-2xl font-bold", children: t("privacy.section1_title") }),
            /* @__PURE__ */ jsx("p", { className: "text-slate-600 dark:text-slate-400", children: t("privacy.section1_content") })
          ] }),
          /* @__PURE__ */ jsxs("section", { children: [
            /* @__PURE__ */ jsx("h2", { className: "mb-4 text-2xl font-bold", children: t("privacy.section2_title") }),
            /* @__PURE__ */ jsx("p", { className: "text-slate-600 dark:text-slate-400", children: t("privacy.section2_content") })
          ] }),
          /* @__PURE__ */ jsxs("section", { children: [
            /* @__PURE__ */ jsx("h2", { className: "mb-4 text-2xl font-bold", children: t("privacy.section3_title") }),
